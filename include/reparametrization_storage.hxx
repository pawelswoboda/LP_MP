#ifndef LP_MP_POTENTIAL_STORAGE_CLASSES
#define LP_MP_POTENTIAL_STORAGE_CLASSES
...
public:
   ...
   const REAL operator[](const INDEX i) const {
      ...
      assert(std::abs( test_val - true_val) < 1e-6);
      */
...
public:
   ...
   // note: we do not provide read access via operator[], as this allows the message to omit all reads completely
   const INDEX size() const 
   { 
...
#endif // LP_MP_POTENTIAL_STORAGE_CLASSES
